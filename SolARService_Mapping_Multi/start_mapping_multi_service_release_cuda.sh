...
export SERVER_EXTERNAL_URL=0.0.0.0:60051
...
LD_LIBRARY_PATH=$ld_library_path ./SolARService_Mapping_Multi -m SolARService_Mapping_Multi_modules.xml -p SolARService_Mapping_Multi_properties.xml -t cuda $@
