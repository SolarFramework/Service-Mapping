...
SOURCES += \
    ...
    SolARService_Mapping_Multi.cpp
...
linux {
    ...
    run_install_cuda.files = $${PWD}/start_mapping_multi_service_cuda.sh
    CONFIG(release,debug|release) {
        run_install_cuda.extra = cp $$files($${PWD}/start_mapping_multi_service_release_cuda.sh) $${PWD}/start_mapping_multi_service_cuda.sh
    }
    CONFIG(debug,debug|release) {
        run_install_cuda.extra = cp $$files($${PWD}/start_mapping_multi_service_debug_cuda.sh) $${PWD}/start_mapping_multi_service_cuda.sh
    }
...
DISTFILES += \
    ...
    start_mapping_multi_service_debug_cuda.sh \
    start_mapping_multi_service_release.sh \
    start_mapping_multi_service_release_cuda.sh
