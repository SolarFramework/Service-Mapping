...
sed -i -e "s/MAPUPDATE_SERVICE_URL/$MAPUPDATE_SERVICE_URL/g" /.xpcf/SolARService_Mapping_Multi_properties_cuda.xml
...
sed -i -e "s/RELOCALIZATION_SERVICE_URL/$RELOCALIZATION_SERVICE_URL/g" /.xpcf/SolARService_Mapping_Multi_properties_cuda.xml
...
./SolARService_Mapping_Multi -m /.xpcf/SolARService_Mapping_Multi_modules_cuda.xml -p /.xpcf/SolARService_Mapping_Multi_properties_cuda.xml
