...
TARGET = SolARServiceTest_Mapping_Multi_Producer
VERSION=1.0.0
...
SOURCES += \
    SolARServiceTest_Mapping_Multi_Producer.cpp
...
xml_files.files =  $$files($${PWD}/SolARServiceTest_Mapping_Multi_Producer_conf.xml)
