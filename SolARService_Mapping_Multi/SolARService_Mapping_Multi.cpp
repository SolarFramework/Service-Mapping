...
const std::string MAP_UPDATE_CONF_FILE = "./SolARService_Mapping_Multi_MapUpdate_conf.xml";
...
int main(int argc, char* argv[])
{
    ...
    cxxopts::Options option_list("SolARService_Mapping_Multi",
                                 "SolARService_Mapping_Multi - The commandline interface to the xpcf grpc server application.\n");
    ...
    {
        std::cout << "SolARService_Mapping_Multi version " << MYVERSION << std::endl << std::endl;
        return 0;
    }
